<template>
  <Section label="About Me">
    <p class="mb-6">Hey there! I'm David, and I'm a software engineer living in Brooklyn. I work in the AV industry, writing code and creating user interfaces to control all sorts of equipment from a single place. You ever been in one of those fancy conference rooms and seen a touch panel sitting on the table that runs everything (start meetings, dim the lights, turn on the TV, etc.)? Yep, that's me. Whether in boardrooms, classrooms, casinos, or hotels, I get all the equipment to work together so you can control it all from one place.</p>
